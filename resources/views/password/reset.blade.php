...
@section('title', 'Reset Password | Hotels Automation')
@section('css')
    <link rel="stylesheet" href="{{ asset('css/pages/password/reset.css') }}">
@endsection
@section('content')
    <div class="reset-wrapper">
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <form action={{ route('reset.password') }} method="post" autocomplete="off" id="resetPasswordForm">
                        @csrf
...
@section('script')
    ...
    <script src="{{ asset('js/password/reset/validatePassword.js') }}"></script>
@endsection
